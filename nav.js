/* nav.js — the shared top bar for every hockey page (portal, league, team, ops).
   Include near the top of <body>:
     <script src="<path-to>/nav.js" data-root="<relative path to the hockey root, no trailing slash>"></script>
